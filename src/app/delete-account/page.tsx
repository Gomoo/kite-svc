    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center px-10 py-24">
        ...
        <p className="max-w-[350px] p-8 text-center">
          ...
          information would be purged from our servers. You will not be able to log in anymore and
          an email would be sent to you when the purge has been completed.
        </p>
